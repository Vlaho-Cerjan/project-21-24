...
interface ActionArtistHeaderProps {
    handleSubmit: (event: React.MouseEvent<HTMLButtonElement>) => void,
    action: "edit" | "add",
}

const ActionArtistHeader = ({action, handleSubmit}: ActionArtistHeaderProps) => {
    ...
    return (
        <HeaderBox sx={{
            ...
            <BackButton />
            <TextBold20
                text={action==="edit"?t("editArtist"):t("createArtist")}
                textComponent="h2"
                containerSx={{
                    lineHeight: "24px",
                    flexGrow: 1
            ...
            <HeaderContainer sx={{
                ...
                >
                    <TextBold14
                        text={action==="edit"?t("updateArtist"):t("createArtist")}
                        textProps={{
                            sx: {
...
export default ActionArtistHeader;