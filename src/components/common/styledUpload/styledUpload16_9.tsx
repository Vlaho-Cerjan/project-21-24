...
const StyledUpload16_9 = ({file, setFile, type, noPreview}: StyledUploadProps) => {
        ...
        <StyledUploadContainer>
            ...
            <StyledUploadImageContainer>
                ...
                <StyledUploadButtonsContainer>
                    ...
                    {!enableCropper?
                        <StyledButton onClick={handleOpenCrop}>
                    ...
                    :
                        <Box sx={{
                            ...
                            <StyledButton onClick={handleCloseCrop}>
                                <IconContainerDarkModeDark>
                                    <ClearRounded />
                                </IconContainerDarkModeDark>
                            </StyledButton>
...
export default StyledUpload16_9;